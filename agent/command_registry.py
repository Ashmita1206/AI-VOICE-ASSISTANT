...
_REGISTRY: list[IntentDefinition] = [
    ...
    IntentDefinition(
        ...
        patterns=[
            IntentPattern("send a telegram message to {contact} saying {message}"),
            IntentPattern("send a telegram to {contact} saying {message}"),
            IntentPattern("send a message to {contact} on telegram saying {message}"),
            IntentPattern("send a message to {contact} in telegram saying {message}"),
            IntentPattern("send a message on telegram to {contact} saying {message}"),
            IntentPattern("send a message in telegram to {contact} saying {message}"),
            IntentPattern("send a {message} message to {contact} on telegram"),
            IntentPattern("send a {message} message to {contact} in telegram"),
            IntentPattern("send {message} to {contact} on telegram"),
            IntentPattern("send {message} to {contact} in telegram"),
            IntentPattern("send {message} on telegram to {contact}"),
            IntentPattern("send {message} in telegram to {contact}"),
            IntentPattern("message {contact} on telegram saying {message}"),
            IntentPattern("message {contact} in telegram saying {message}"),
            IntentPattern("message {contact} on telegram that {message}"),
            IntentPattern("message {contact} in telegram that {message}"),

            IntentPattern("telegram on {contact} to message send of {message}"),
            IntentPattern("telegram on {contact} to message send {message}"),
            IntentPattern("telegram on {contact} to send {message}"),
            IntentPattern("telegram on {contact} send {message}"),
            IntentPattern("telegram {contact} {message} tell"),
            IntentPattern("telegram pe {contact} ko message bhejo ki {message}"),
            IntentPattern("telegram par {contact} ko message bhejo ki {message}"),
            IntentPattern("telegram pe {contact} ko {message} bhejo"),
            IntentPattern("telegram par {contact} ko {message} bhejo"),
            IntentPattern("telegram pe {contact} ko bol do ki {message}"),
            IntentPattern("telegram par {contact} ko bol do ki {message}"),
            IntentPattern("telegram pe {contact} ko bol do {message}"),
            IntentPattern("telegram par {contact} ko bol do {message}"),
            IntentPattern("telegram pe {contact} ko send karo {message}"),
            IntentPattern("telegram par {contact} ko send karo {message}"),
            IntentPattern("{contact} ko telegram par bol do ki {message}"),
            IntentPattern("{contact} ko telegram pe bol do ki {message}"),
            IntentPattern("{contact} ko telegram par bol do {message}"),
            IntentPattern("{contact} ko telegram pe bol do {message}"),
            IntentPattern("{contact} ko telegram par message bhejo ki {message}"),
            IntentPattern("{contact} ko telegram pe message bhejo ki {message}"),
            IntentPattern("{contact} ko telegram par {message} bhejo"),
            IntentPattern("{contact} ko telegram pe {message} bhejo"),
        ],
        keywords=["telegram", "message", "send", "tell", "text", "chat", "bhejo", "bol"],
    ...
    IntentDefinition(
        ...
        patterns=[
            ...
            IntentPattern("whatsapp on {contact} to {message} send"),
            IntentPattern("whatsapp pe {contact} ko message bhejo ki {message}"),
            IntentPattern("whatsapp pe {contact} ko {message} bhejo"),
        ],
