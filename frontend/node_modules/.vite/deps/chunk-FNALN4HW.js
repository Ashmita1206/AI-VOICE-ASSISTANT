...
var URL_SOURCE_PHASE_IMPORTS = "es-module-syntax/#source-phase-import";
...
var NON_EXTERNAL_SOURCE_PHASE_IMPORT = "NON_EXTERNAL_SOURCE_PHASE_IMPORT";
...
var SOURCE_PHASE_FORMAT_UNSUPPORTED = "SOURCE_PHASE_FORMAT_UNSUPPORTED";
...
function logCircularChunk(cyclePath, isManualChunkConflict) {
  return {
    code: CIRCULAR_CHUNK,
    ids: cyclePath,
    message: `Circular chunk: ${cyclePath.join(" -> ")}. ${isManualChunkConflict ? `Please adjust the manual chunk logic for these chunks.` : `Please consider disabling the "output.onlyExplicitManualChunks" option, as enabling it causes modules located between the modules included in the manual chunk "${cyclePath.at(-2)}" to be extracted into the separate chunk "${cyclePath.at(-1)}".`}`
  };
}
...
rollup/dist/es/shared/parseAst.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-FNALN4HW.js.map
